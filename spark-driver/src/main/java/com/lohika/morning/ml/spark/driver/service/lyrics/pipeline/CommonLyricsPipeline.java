...
public abstract class CommonLyricsPipeline implements LyricsPipeline {
    ...
    @Value("${lyrics.training.set.file.path}")
    private String lyricsTrainingSetFilePath;
    ...
    Dataset<Row> readLyrics() {
        Dataset<Row> rawTrainingSet = sparkSession
                ...
                .format("csv")
                .option("header", "true")
                .load(lyricsTrainingSetFilePath);
    ...
    public void setLyricsTrainingSetFilePath(String lyricsTrainingSetFilePath) {
        this.lyricsTrainingSetFilePath = lyricsTrainingSetFilePath;
    }
